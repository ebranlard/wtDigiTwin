------- OpenFAST INPUT FILE ------------------------------------------------
NREL 1.5sle - 60Hz 77m Rotor 80m Hub Height SN: 15082495  
---------------------- SIMULATION CONTROL --------------------------------------
False         Echo            - Echo input data to <RootName>.ech (flag)
FATAL         AbortLevel      - Error level when simulation should abort (string) {"WARNING", "SEVERE", "FATAL"}
         50    TMax            - Total run time (s)
     0.010    DT              - Recommended module time step (s) %RRD changed to 0.01 to try large DT
...
---------------------- INPUT FILES ---------------------------------------------
"TurbWindStep_ED.dat"       EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
"unused"                        BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"unused"                        BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"unused"                        BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"TurbWindStep_IW.dat"      InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"../NREL5MW/NREL5MW_AD15.05.dat"         AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"../NREL5MW/NREL5MW_SD.dat"      ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
